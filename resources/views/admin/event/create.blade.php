    ...
    <div class="min-h-screen bg-white">
        <div class="border-b border-gray-200">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <p class="text-sm text-gray-500 mt-1">Buat event baru dan mulai kelola tiket penjualan</p>
            </div>
        </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <!-- Form Card -->
            <form id="eventForm" method="post" action="{{ route('admin.events.store') }}" enctype="multipart/form-data" class="bg-white rounded-lg shadow-sm border border-gray-200">
                @csrf
                ...
                <div class="px-6 sm:px-8 py-6 space-y-6">
                    ...
                    <div id="imagePreview" class="hidden">
                        ...
                        <div class="relative inline-block w-full max-w-xs">
                            <img id="previewImg" src="" alt="Preview" class="w-full rounded-md border border-gray-200">
