                        ...
                        <div class="flex justify-between items-start gap-4">
                            <div>
                                ...
                                <div class="mt-3 flex gap-2 items-center">
                                    <span
                                        class="badge badge-primary">{{ $event->category?->name ?? 'Tanpa Kategori' }}</span>
                                ...
                                <div class="card card-side shadow-sm p-4 items-center">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-500">Stok: <span
                                                id="stock-{{ $ticket->id }}">{{ $ticket->stock }}</span></p>
                                    ...
                                    <div class="w-44 text-right">
                                        ...
                                        <div class="mt-3 flex items-center justify-end gap-2">
                                            ...
                                            <input id="qty-{{ $ticket->id }}" type="number" min="0"
                                                max="{{ $ticket->stock }}" value="0"
                                        ...
                                        <div class="text-sm text-gray-500 mt-2">Subtotal: <span
                                                id="subtotal-{{ $ticket->id }}">Rp 0</span>
                                        </div>
                                    </div>
                                </div>
                            @empty
            ...
            function updateSummary() {
                ...
                Object.values(tickets).forEach(t => {
                    ...
                    if (qty > 0) {
                        ...
                        selectedHtml +=
                            `<div class="flex justify-between"><span>${t.type} x ${qty}</span><span>${formatRupiah(qty * t.price)}</span></div>`;
                    }
                });
